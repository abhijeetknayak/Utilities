CREATE TABLE employee(
    ...
    salary INT,
    super_id INT,
    branch_id INT,  # Branch ID foreign key not yet available
    PRIMARY KEY(emp_id)
);
...
INSERT INTO employee VALUES(100, "David", "Wallace", '1961-11-17', 'M', 250000, NULL, NULL);
INSERT INTO branch VALUES(1, 'Corporate', 100, '2006-02-09');

UPDATE employee
SET employee.branch_id = 1
...
INSERT INTO client_table VALUES(400, 'Dunmore Highschool', 2);
INSERT INTO client_table VALUES(401, 'Lackawana Country', 2);
INSERT INTO client_table VALUES(402, 'FedEx', 3);
INSERT INTO client_table VALUES(403, 'John Dalky Law, LLC', 3);
INSERT INTO client_table VALUES(404, 'Scranton Whitepages', 2);
INSERT INTO client_table VALUES(405, 'Times Newspaper', 3);
